...
**Ocean is lagging by 1-2 months in commit activity compared to solar and carbon.** Given that ocean intervention is theoretically the most urgent climate intervention (because ocean warming has committed warming of 1.5°C even if we stop emissions today), the codebase is the least active.
